...
The description of Bag End is "You find yourself in a cavernicolous and airy room. Doors, windows and ceilings are round, like if someone has carved holes in the earth itself. Outside you can hear the loughter of children and the chirping of birds.".
A little table, a trunk and a cupboard are in Bag End.
The trunk is an openable and closed container. 
The description of the trunk is "An old and heavy thing, on which the name BAGGINS is roughly carved.". 
The green book is a book on the little table. 
The map is a book on the little table. 
...
The quote of the green book is "The hint". 
The quote of the map is "Incredibly detailed, it was probably drawn by one of your ancestors. Bag End stands proudly (if a bit larger than the scale would allow), in the middle of the Shire. To the east you can see great mountains and the city of Rinvendell and in the south, encased in a smudge of black ink, there is Mount Doom. [line break]".
